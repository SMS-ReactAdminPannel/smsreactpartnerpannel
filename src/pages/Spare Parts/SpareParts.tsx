    ...
    <div className="p-6">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {filteredParts.map((part) => (
          <div
            key={part.id}
            className="group relative border rounded-lg overflow-hidden shadow transition-all duration-300 cursor-pointer h-[260px] bg-[#f5e7c2] hover:scale-100 hover:shadow-[0_0_10px_rgba(155,17,30,0.5)]"

...
import { getDashboard, getTransaction, } from "./Services";
...
const Dashboard = () => {
  ...
  try {
    const response: any = await getTransaction('weekly'); // or 'monthly', 'yearly'
  ...
  const bookingData =
    dashboard?.servicebooking?.map((item: any) => ({
      name: item.service_name,
      bookings: item.totalBookings || 10,
    })) || [];
        ...
        <div className="mx-1 justify-center items-center px-2">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 px-10">
            ...
            <DashboardCard
              ...
              value={dashboard?.servicesDetails?.pending || 0}
              per={-5}
              perColor="#f87171"
            ...
            <DashboardCard
              ...
              value={dashboard?.overAllservice || 0}
              per={15}
              perColor="#10b981"
            ...
            <CardContent>
              ...
              <div className="overflow-x-auto">
                <table className="table-auto w-full min-w-max border-collapse">
                  ...
                  <tbody>
                    {dashboard?.RecentBooking?.length > 0 ? (
                      dashboard.RecentBooking.map((booking, index) => {

      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg border-black dark:border-black">
        ...
        {filteredProducts.length > 0 && (
          <nav className="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4" aria-label="Table navigation">
            <span className="text-sm font-normal text-black dark:text-black mb-4 md:mb-0 block w-full md:inline md:w-auto">
            ...
            <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
              <li>
                <button
                  ...
                  className="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-black bg-white border border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-white dark:border-gray-700 dark:text-black  dark:hover:text-black disabled:opacity-50"
                >
                  Previous
                </button>
              </li>
              ...
              <li>
                <button
                  ...
                  className="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100  dark:bg-white  dark:text-black  disabled:opacity-50"
                >
                  Next
                </button>
              </li>

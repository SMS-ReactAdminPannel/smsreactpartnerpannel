...
const CustomerProfileDetails: React.FC<handle> = ({handleBack }) => {
  ...
  const initialProducts: Product[] = [
    {
      ...
      deliveryDate: "Delivered on Apr 11",
      price: "Rs. 45,000",
      status: "Delivered",
      ...
      paymentID: 9874329,
      estimatedDelivery: "Apr 15-17, 2025"
    },
    {
      id: 2,
      title: "Echo Engine Booster Power",
      deliveryDate: "Delivered on Apr 28",
      price: "Rs. 75,000",
      status: "Delivered",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQkkjuSijMAtwQfBBh5I8Kj4hJCbURMNT9BTw&s",
      orderDate: "Apr 20, 2025",
      orderID: 12344,
      brand: "BMW",
      paymentMethod: "online",
      paymentID: 9874329,
      estimatedDelivery: "Apr 26-30, 2025"
    },
    {
      id: 3,
      title: "Boost Engine Booster Power",
      deliveryDate: "Delivered on May 5",
      price: "Rs. 1,00,000",
      status: "Processing",
      image: "https://thumbs.dreamstime.com/b/image-showcases-diverse-range-high-quality-car-spare-parts-meticulously-isolated-against-pristine-white-background-363184337.jpg",
      orderDate: "Apr 29, 2025",
      orderID: 12345,
      brand: "Ferrari",
      paymentMethod: "online",
      paymentID: 9874329,
      estimatedDelivery: "May 3-5, 2025"
    },
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      ...
      <div className="w-full md:w-2/3 lg:w-1/4 p-2 relative"> {/* Added relative positioning */}
                        ...
                        <div className="md:w-3/4 p-4">
                          <div className="flex flex-col h-full justify-between">
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-4 gap-2">
                              <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${product.status === 'Delivered' ? 'bg-green-100 text-green-800' :
                              ...
                              <button
                                ...
                                className="px-4 py-2 hover:bg-amber-600 text-white rounded-lg font-medium transition-colors" style={{ background: "linear-gradient(44.99deg, #700808 11%, #d23c3c 102.34%)" }}
                              >
                                View Details
                              </button>
                            </div>
                        ...
                        <div className="mt-6 space-y-4">
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="font-medium dark:text-black">{selectedProduct.orderID}</p>
                            </div>
                          </div>

                          <div className="flex items-center gap-3">
                            <IoCarSportSharp className="text-gray-500" />
                            <div>
                              <p className="text-sm text-gray-500">Brand</p>
                              <p className="font-medium dark:text-black">{selectedProduct.brand}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <p className="font-medium">{selectedProduct.paymentMethod}</p>
                            </div>
                          </div>

                          <div className="flex items-center gap-3">
                            <FaOrcid className="text-gray-500" />
                            <div>
                              <p className="text-sm text-gray-500">Payment ID</p>
                              <p className="font-medium">{selectedProduct.paymentID}</p>
                            </div>
                          </div>
